...
from logscale_py.exceptions import LogScaleException
...
class LogScaleApi:
    ...
    def basic_query(self, repo: str, query: str):
        result = self._rest_adapter.post(endpoint='{repo}/query')
        result_logs = BasicQuery(**result.data[0])
        return result_logs