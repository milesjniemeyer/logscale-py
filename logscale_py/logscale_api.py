...
class LogScaleAPI:
    ...
    def query_job(self, repo: str, query_string: str, event_id: str = None, number_of_events_after: int = None, number_of_events_before: int = None, timestamp: int = None, allow_event_skipping: bool = False, arguments: Dict = None, around: str = None, auto_bucket_count: int = None, end: str = 'now', include_delete_events: bool = None, ingest_end: str = None, ingest_start: str = None, is_alert_query: bool = None, is_interactive: bool = False, is_live: bool = False, is_repeating_subquery: bool = False, language_version: str = None, no_result_until_done: bool = False, show_query_event_distribution: bool = False, start: str = '24hours', time_zone: str = None, time_zone_offset_minutes: int = None, use_ingest_time: bool = False):
        data = {'allowEventSkipping': allow_event_skipping,
                'arguments': arguments,
                'around': around,
                'eventId': event_id,
